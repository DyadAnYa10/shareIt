...
class RequestServiceTest {
    private final ru.practicum.server.request.RequestService requestService;

    @Test
    @Order(0)
    @Sql(value = {"/src/test/resources/test-schema.sql", "/users-create-test.sql"})
    void createTest() {
        long userId = 1L;
    ...
    @Test
    @Order(1)
    @Sql(value = {"/src/test/resources/item-for-request-create-test.sql"})
    void getById() {
        long requestId = 1L;
        long userId = 1L;
